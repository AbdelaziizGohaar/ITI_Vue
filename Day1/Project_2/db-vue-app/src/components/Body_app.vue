...
export default {
  ...
  data: () => ({
        isform:false,
      students: [
        { id: 1, name: 'Ronaldo', city: 'Spain' },
        { id: 2, name: 'Messi', city: 'Spain' },
        { id: 3, name: 'Ozil', city: 'Spain' },
        { id: 4, name: 'Etoo', city: 'England' },
        { id: 5, name: 'Forlan', city: 'Uruguay' }
      ],
      newStudent: {
        name: '',
        city: ''
...
button {
  box-shadow: 0 4px 8px rgba(55, 31, 161, 0.5);
}
...
.modal-overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(209, 177, 177, 0.5);
  z-index: 1040;
}
</style>